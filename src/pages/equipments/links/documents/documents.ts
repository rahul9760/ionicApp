...
import { CreateLinkedDocumentsForEquipments } from '../documents/create/create';
...
@Component({
  ...
  providers: [TasksServiceProvider,FunctionsHelper,InfrastructureServiceProvider, EquipmentServiceProvider]
})

export class LinkedDocumentsWithEquipments {
  ...
  create(){
   this.navCtrl.push(CreateLinkedDocumentsForEquipments, { equipment_id : this.params.get('equipment_id') })
  }
      ...
      let alert = this.alertCtrl.create({
        ...
        buttons: [
          ...
          },
          {
            text: 'Ok',
            handler: () => {
              this.EquipmentService.deleteDocumentLink(t.id)
              .then(data => {
