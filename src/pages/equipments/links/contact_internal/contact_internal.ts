...
import { CreateLinkedContactInternalForEquipments } from '../contact_internal/create/create';
...
@Component({
  ...
  providers: [TasksServiceProvider,DocumentServiceProvider, EquipmentServiceProvider]
})

export class LinkedContactInternalWithEquipments {
  ...
  create(){
   this.navCtrl.push(CreateLinkedContactInternalForEquipments, { equipment_id : this.params.get('equipment_id') })
  }
