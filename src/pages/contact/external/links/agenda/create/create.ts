...
import { LinkedAgendaWithCE } from '../agenda';
...
export class CreateLinkedAgendaForCE {
  ...
  addTask(){
    this.navCtrl.push(AgendaCreate, { page: 'linked_contact_external', row_id : this.params.get('row_id'), request_id : this.params.get('contact_id') })
  }
