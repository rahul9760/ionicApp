...
export class CreateLinkedDocumentForCE {
  ...
  addDocument(){
    this.navCtrl.push( Screen1, { page: 'linked_contact_external', request_id: this.params.get('contact_id'), row_id: this.params.get('row_id') } )
  }
