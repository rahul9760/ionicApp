...
import { CreateLinkedDocumentForCE } from '../documents/create/create';
...
export class LinkedDocumentsWithCE {
  ...
  create(){
   this.navCtrl.push(CreateLinkedDocumentForCE, { row_id : this.params.get('row_id'), contact_id : this.params.get('contact_id') })
  }
      ...
      let alert = this.alertCtrl.create({
        ...
        buttons: [
          ...
          },
          {
            text: 'Ok',
            handler: () => {
              this.ContactService.deleteDocumentLink(contact.id)
              .then(data => {
