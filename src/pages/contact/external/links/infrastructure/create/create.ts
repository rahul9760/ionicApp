...
import { LinkedInfrastructureWithCE } from '../infrastructure';
...
export class CreateLinkedInfrastructureForCE {
  ...
  save(){
    ...
    .then(data => {
      ...
      if( data.status ){
        this.navCtrl.push(LinkedInfrastructureWithCE , { row_id : this.params.get('row_id'), contact_id : this.params.get('contact_id') } )
      }
