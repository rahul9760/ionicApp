...
import { CreateLinkedAgendaForCI } from '../agenda/create/create';
...
export class LinkedAgendaWithCI {
  ...
  create(){
   this.navCtrl.push(CreateLinkedAgendaForCI, { row_id : this.params.get('row_id'), contact_id : this.params.get('contact_id') })
  }
      ...
      let alert = this.alertCtrl.create({
        ...
        buttons: [
          ...
          },
          {
            text: 'Ok',
            handler: () => {
              this.ContactService.deleteAgendaLinkCI(agenda.id)
              .then(data => {
