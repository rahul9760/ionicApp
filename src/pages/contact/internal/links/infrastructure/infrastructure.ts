...
import { CreateLinkedInfrastructureForCI } from './create/create';
...
export class LinkedInfrastructureWithCI {
  ...
  create(){
   this.navCtrl.push(CreateLinkedInfrastructureForCI, { row_id : this.params.get('row_id'), contact_id : this.params.get('contact_id') })
  }
      ...
      let alert = this.alertCtrl.create({
        ...
        buttons: [
          ...
          },
          {
            text: 'Ok',
            handler: () => {
              this.ContactService.deleteInfrastructureLinkCI(contact.id)
              .then(data => {
