...
import { CreateLinkedEquipmentForCI } from './create/create';
...
export class LinkedEquipmentWithCI {
  ...
  create(){
   this.navCtrl.push(CreateLinkedEquipmentForCI, { row_id : this.params.get('row_id'), contact_id : this.params.get('contact_id') })
  }
