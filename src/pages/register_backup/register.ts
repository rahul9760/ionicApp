...
export class RegisterPage {
  ...
  Register(){
    ...
    let formValidationCheck = this.validation.validateFields(this.register);
    if(typeof formValidationCheck !== "undefined"){
      console.log("Register :"+JSON.stringify(formValidationCheck));
      this.Notifications.presentToast(formValidationCheck);
      return false;
    }
    if(this.register.password == this.register.confirm_password){
      ...
      console.log("register form data :"+JSON.stringify(this.register));

      console.log("Password Length :"+this.register.password.length);

      if(this.register.password.length < 6){
        this.Notifications.dismissLoader();
        this.Notifications.presentToast("Password should be of atleast 6 digits.");
      }
      else if(this.register.password.length > 10){
        this.Notifications.dismissLoader();
        this.Notifications.presentToast("Password should not be more than 10 digits.");
      }
      else{
        this.Notifications.presentLoader();
        ...
        //       this.Notifications.dismissLoader();
        //       this.Notifications.uploadingToast("Registered successfully");
