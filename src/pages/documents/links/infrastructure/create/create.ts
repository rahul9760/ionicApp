...
import { LinkedInfrastructureWithDocuments } from '../infrastructure';
...
export class CreateLinkedInfrastructureForDocuments {
  ...
  save(){
    ...
    .then(data => {
      ...
      if( data.status ){
        this.navCtrl.push(LinkedInfrastructureWithDocuments , { document_id : this.params.get('document_id')} )
      }
