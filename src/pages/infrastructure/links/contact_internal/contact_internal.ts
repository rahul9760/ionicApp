...
import { CreateLinkedContactInternalForInfrastructure } from '../contact_internal/create/create';
...
export class LinkedContactInternalWithInfrastructure {
  ...
  create(){
   this.navCtrl.push(CreateLinkedContactInternalForInfrastructure, { location_id : this.params.get('location_id') })
  }
      ...
      let alert = this.alertCtrl.create({
        ...
        buttons: [
          ...
          },
          {
            ...
            handler: () => {
               this.Notification.presentLoader();
                 this.InfrastructureService.deleteLinkedContactInternal( { id : contact.link_id } )
                 .then(data => {
                   this.Notification.dismissLoader();
                   this.getContacts();
               });
