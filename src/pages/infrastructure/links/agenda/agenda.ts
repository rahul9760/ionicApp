...
import { CreateLinkedAgendaForInfrastructure } from '../agenda/create/create';
...
@Component({
  ...
  providers: [FunctionsHelper,InfrastructureServiceProvider]
})

export class LinkedAgendaWithInfrastructure {
  ...
  create(){
   this.navCtrl.push(CreateLinkedAgendaForInfrastructure, { location_id : this.params.get('location_id') })
  }
      ...
      let alert = this.alertCtrl.create({
        ...
        buttons: [
          ...
          },
          {
            text: 'Ok',
            handler: () => {
              this.InfrastructureService.deleteAgendaLink(agenda.id)
              .then(data => {
